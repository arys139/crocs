...
<div class="container">
<div id="tab" class="animate-bottom" style="display:none;">
<button class="tablinks" onclick="cesummary(event, 'report1')" id="defaultOpen">Report 1</button>
<button class="tablinks" onclick="cesummary(event, 'report2')">Report 2</button>
<button class="tablinks" onclick="cesummary(event, 'report3')">Report 3</button>
</div>
...
echo "<div id='tablereport1'>";
echo '<table width="250px" border="1" align="center">
  <tr>
    <th width=40%; style="background-color:#FFA500;">PRODUCT NAME</th>
    <th width=60%; style="background-color:#FFA500;">TOTAL EQUIPMENT</th> 
  </tr>';
$OVERALL1 = 0;
...
function drawChart() {
  ...
  // Set chart options
  var options = {title:'',
  titleTextStyle: {fontName: 'Lato', fontSize: 11, bold: true}, 
    height: 300,
    is3D: true,
  //colors:['#0F4F8D','#2B85C1','#8DA9BF','#F2C38D','#E6AC03','#F09B35', '#D94308', '#013453'],
  pieSliceTextStyle: {color: 'white',},
  ...
  // Instantiate and draw our chart, passing in some options.
  var chart = new google.visualization.PieChart(document.getElementById('summarychart'));
  chart.draw(data, options);
}
...
<script>
function cesummary(evt, reportName) {
