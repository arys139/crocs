...
<!--habis script sini-->
 ...
 //Search database
    ...
    $sql = $sql."CROCS_EPE_NAME,CROCS_EPE_PORT,CROCS_CPE_ID,CROCS_WAN_CPE_INTERFACE,CROCS_BAU_SERVICE_ID,CROCS_BS_NODE_PE,CROCS_BS_LAN_IP,";
	...
	$sql = $sql."CROCS_HO_ALERT_REMARKS ";
...
echo '
 <tr><td style="background-color:#FFA500;"><font size="1">Reseller:</font></td><td><input style="font-size:12px" size="50" style="background-color:#F5F5F5;" readonly="true" type="text" id="CROCS_RESELLER" name="CROCS_RESELLER" value="'.$CROCS_RESELLER.'"></td>';
if ($Role <> 'GUEST'){
 ...
 echo '<td style="background-color:#FFA500;"><font size="1">Contact #2:</font></td><td><input style="font-size:12px" size="50" style="background-color:#F5F5F5;" readonly="true" type="text" id="CROCS_CUST_CONTACT_1" name="CROCS_CUST_CONTACT_2" value="'.$CROCS_CUST_CONTACT_2.'"></td></tr>';
}

echo '
 <tr><td style="background-color:#FFA500;"><font size="1">BAU Service ID:</font></td><td><input style="font-size:12px" size="50" style="background-color:#F5F5F5;" readonly="true" type="text" id="CROCS_NODE_PE" name="CROCS_NODE_PE" value="'.$CROCS_NODE_PE.'"'.$readonly.'></td>';
...
if ($Role <> 'GUEST'){
 ...
 echo '<td style="background-color:#FFA500;"><font size="1">Contact #3:</font></td><td><input style="font-size:12px" size="50" style="background-color:#F5F5F5;" readonly="true" type="text" id="CROCS_CUST_CONTACT_1" name="CROCS_CUST_CONTACT_3" value="'.$CROCS_CUST_CONTACT_3.'"></td></tr>';
}

 if ($Role <> 'GUEST'){
 echo '
 <tr><td style="background-color:#FFA500;"><font size="1">Branch Code:</font></td><td><input style="font-size:12px" size="50" style="background-color:#F5F5F5;" readonly="true" type="text" id="CROCS_BR_CODE" name="CROCS_BR_CODE" value="'.$CROCS_BR_CODE.'"'.$readonly.'></td><td></td><td></td></tr>
 						 ...
 						 if ($Role <> 'GUEST'){
 									echo '<tr><td style="background-color:#FFA500;"><font size="1">CPE ID :</font></td>
 									         <td><input style="font-size:12px" size="53" style="background-color:#F5F5F5;" readonly="true" type="text" id="CROCS_CPE_ID" name="CROCS_CPE_ID" value="'.$CROCS_CPE_ID.'"></td></tr>
 												<tr><td style="background-color:#ADD8E6;"><font size="1">WAN CPE Interface:</font></td><td style="background-color:#ADD8E6;"><input style="font-size:12px" size="50" type="text" 
                                           id="CROCS_WAN_CPE_INTERFACE" name="CROCS_WAN_CPE_INTERFACE" value="'.$CROCS_WAN_CPE_INTERFACE.'"></td></tr>
							 ...
							 '; 
                                    ...
                                    <tr>
									<td style="background-color:#FFA500;"><font size="1">WAN CPE Interface:</font></td>
									<td><input style="font-size:12px" size="50" style="background-color:#F5F5F5;" readonly="true" type="text" id="CROCS_WAN_CPE_INTERFACE" name="CROCS_WAN_CPE_INTERFACE" value="'.$CROCS_WAN_CPE_INTERFACE.'">
									</td>
									</tr>
                                    <tr>
...
<td style="background-color:#FFA500;"><font size="1">Secondary Service ID Access Type:</font></td><td><input style="font-size:12px" size="50" style="background-color:#F5F5F5;" readonly="true" type="text" id="CROCS_BS_ACCESS_TYPE" name="CROCS_BS_ACCESS_TYPE" value="'.$CROCS_BS_ACCESS_TYPE.'"></td>
 ...
 <tr><td style="background-color:#FFA500;"><font size="1">PS_Routing Protocol:</font></font></td><td><input style="font-size:12px" size="50" style="background-color:#F5F5F5;" readonly="true" type="text" id="CROCS_PS_ROUTING_PROTOCOL" name="CROCS_PS_ROUTING_PROTOCOL" value="'.$CROCS_PS_ROUTING_PROTOCOL.'"></td><td></td>
</td><td style="background-color:#FFA500;"><font size="1">BS_Routing Protocol:</td><td><input style="font-size:12px" size="50" style="background-color:#F5F5F5;" readonly="true" type="text" id="CROCS_BS_ROUTING_PROTOCOL" name="CROCS_BS_ROUTING_PROTOCOL" value="'.$CROCS_BS_ROUTING_PROTOCOL.'"></td>
</tr> 

 <tr><td style="background-color:#FFA500;"><font size="1">PS_CE WAN IP Address:</font></font></td><td><input style="font-size:12px" size="50" style="background-color:#F5F5F5;" readonly="true" type="text" id="CROCS_PS_CE_WAN_IP" name="CROCS_PS_CE_WAN_IP" value="'.$CROCS_PS_CE_WAN_IP.'"></td><td></td>
<td style="background-color:#FFA500;"><font size="1">BS_CE WAN IP Address:</font></td><td><input style="font-size:12px" size="50" style="background-color:#F5F5F5;" readonly="true" type="text" id="CROCS_BS_CE_WAN_IP" name="CROCS_BS_CE_WAN_IP" value="'.$CROCS_BS_CE_WAN_IP.'"></td>
</tr>

 <tr></td><td style="background-color:#FFA500;"><font size="1">PS_Framed IP Address:</font></font></td><td><input style="font-size:12px" size="50" style="background-color:#F5F5F5;" readonly="true" type="text" id="CROCS_PS_FRAMED_IP" name="CROCS_PS_FRAMED_IP" value="'.$CROCS_PS_FRAMED_IP.'"></td><td></td>
<td style="background-color:#FFA500;"><font size="1">BS_Framed IP Address:</font></td><td><input style="font-size:12px" size="50" style="background-color:#F5F5F5;" readonly="true" type="text" id="CROCS_BS_FRAMED_IP" name="CROCS_BS_FRAMED_IP" value="'.$CROCS_BS_FRAMED_IP.'"></td>
</tr>

 <tr><td style="background-color:#FFA500;"><font size="1">QOS:</font></td><td><input style="font-size:12px" size="50" style="background-color:#F5F5F5;" readonly="true" type="text" id="CROCS_QOS" name="CROCS_QOS" value="'.$CROCS_QOS.'"></td><td></td>
<td style="background-color:#FFA500;"><font size="1">Profile:</font></td><td><input style="font-size:12px" size="50" style="background-color:#F5F5F5;" readonly="true" type="text" id="CROCS_PROFILE" name="CROCS_PROFILE" value="'.$CROCS_PROFILE.'"></td>
</tr> 
';
...
<td style="background-color:#FFA500;"><font size="1">Username:</font></td><td><input style="font-size:12px" size="50" style="background-color:#F5F5F5;" readonly="true" type="text" id="CROCS_USERNAME" name="CROCS_USERNAME" value="'.$CROCS_USERNAME.'"></td>
</tr>

 <tr><td style="background-color:#ADD8E6;"><font size="1">LAN IP :</font></td><td style="background-color:#ADD8E6;"><input style="font-size:12px" size="50" type="text" id="CROCS_LAN_IP" name="CROCS_LAN_IP" value="'.$CROCS_LAN_IP.'"></td><td style="background-color:#ADD8E6;" size="30"><font size="1">Format: Max to 5 IPs <br> Eg: 11.159.5.147/11.159.6.147/11.159.7.147/11.159.8.147</font></td>
</td><td style="background-color:#FFA500;"><font size="1">Password:</font></td><td><input style="font-size:12px" size="50" style="background-color:#F5F5F5;" readonly="true" type="text" id="CROCS_PASSWORD" name="CROCS_PASSWORD" value="'.$CROCS_PASSWORD.'"></td>
</tr> 
...
<td style="background-color:#FFA500;"><font size="1">Output Policy:</font></td><td><input style="font-size:12px" size="50" style="background-color:#F5F5F5;" readonly="true" type="text" id="CROCS_OUTPUT_POLICY" name="CROCS_OUTPUT_POLICY" value="'.$CROCS_OUTPUT_POLICY.'"></td>
 ...
 <tr><td style="background-color:#FFA500;"><font size="1">UPE HOSTNAME :</font></td><td><input style="font-size:12px" size="50" style="background-color:#F5F5F5;" readonly="true" type="text" id="CROCS_UPE_HOSTNAME" name="CROCS_UPE_HOSTNAME" value="'.$CROCS_UPE_HOSTNAME.'"></td><td></td>
<td style="background-color:#FFA500;"><font size="1">PE Node:</font></td><td><input style="font-size:12px" size="50" style="background-color:#F5F5F5;" readonly="true" type="text" id="CROCS_BS_NODE_PE" name="CROCS_BS_NODE_PE" value="'.$CROCS_BS_NODE_PE.'"></td>
</tr>

 <tr>
 <td style="background-color:#FFA500;"><font size="1">UPE ACCESS PORT :</font></td>
 ...
 <td></td>
<td style="background-color:#FFA500;"><font size="1">LAN IP:</font></td><td><input style="font-size:12px" size="50" style="background-color:#F5F5F5;" readonly="true" type="text" id="CROCS_BS_LAN_IP" name="CROCS_BS_LAN_IP" value="'.$CROCS_BS_LAN_IP.'"></td>
</tr> 

 <tr><td style="background-color:#FFA500;"><font size="1">UPE TRUNK PORT :</font></td><td><input style="font-size:12px" size="50" style="background-color:#F5F5F5;" readonly="true" type="text" id="CROCS_UPE_TRUNK_PORT" name="CROCS_UPE_TRUNK_PORT" value="'.$CROCS_UPE_TRUNK_PORT.'"></td><td></td>
<td style="background-color:#FFA500;"><font size="1">UPE LOOPBACK IP:</font></td><td><input style="font-size:12px" size="50" style="background-color:#F5F5F5;" readonly="true" type="text" id="CROCS_BS_UPE_LOOPBACK_IP" name="CROCS_BS_UPE_LOOPBACK_IP" value="'.$CROCS_BS_UPE_LOOPBACK_IP.'"></td>
</tr>
 ';}
else {
 echo '
  ...
  <td><input style="font-size:12px" size="50" style="background-color:#F5F5F5;" readonly="true" type="text" id="CROCS_HQ_IP" name="CROCS_HQ_IP" value="'.$CROCS_HQ_IP.'"></td>
  <td></td>
<td style="background-color:#FFA500;"><font size="1">Username:</font></td>
<td><input style="font-size:12px" size="50" style="background-color:#F5F5F5;" readonly="true" type="text" id="CROCS_USERNAME" name="CROCS_USERNAME" value="'.$CROCS_USERNAME.'"></td>
</tr>

 <tr><td style="background-color:#FFA500;"><font size="1">LAN IP :</font></td><td><input style="font-size:12px" size="50" style="background-color:#F5F5F5;" readonly="true" type="text" id="CROCS_LAN_IP" name="CROCS_LAN_IP" value="'.$CROCS_LAN_IP.'"></td><td></td>
</td><td style="background-color:#FFA500;"><font size="1">Password:</font></td><td><input style="font-size:12px" size="50" style="background-color:#F5F5F5;" readonly="true" type="text" id="CROCS_PASSWORD" name="CROCS_PASSWORD" value="'.$CROCS_PASSWORD.'"></td>
</tr>
...
<td style="background-color:#FFA500;"><font size="1">Input Policy:</font></td><td><input style="font-size:12px" size="50" style="background-color:#F5F5F5;" readonly="true" type="text" id="CROCS_INPUT_POLICY" name="CROCS_INPUT_POLICY" value="'.$CROCS_INPUT_POLICY.'"></td>
 ...
 <tr><td style="background-color:#FFA500;"><font size="1">UPE LOOPBACK IP :</font></td><td><input style="font-size:12px" size="50" style="background-color:#F5F5F5;" readonly="true" type="text" id="CROCS_UPE_LOOPBACK_IP" name="CROCS_UPE_LOOPBACK_IP" value="'.$CROCS_UPE_LOOPBACK_IP.'"></td><td></td>
<td style="background-color:#FFA500;"><font size="1">Output Policy:</font></td><td><input style="font-size:12px" size="50" style="background-color:#F5F5F5;" readonly="true" type="text" id="CROCS_OUTPUT_POLICY" name="CROCS_OUTPUT_POLICY" value="'.$CROCS_OUTPUT_POLICY.'"></td>
</tr>

 <tr>
 <td style="background-color:#FFA500;"><font size="1">UPE HOSTNAME :</font></td><td><input style="font-size:12px" size="50" style="background-color:#F5F5F5;" readonly="true" type="text" id="CROCS_UPE_HOSTNAME" name="CROCS_UPE_HOSTNAME" value="'.$CROCS_UPE_HOSTNAME.'"></td>
 <td></td>
<td style="background-color:#FFA500;"><font size="1">PE Node:</font></td><td><input style="font-size:12px" size="50" style="background-color:#F5F5F5;" readonly="true" type="text" id="CROCS_BS_NODE_PE" name="CROCS_BS_NODE_PE" value="'.$CROCS_BS_NODE_PE.'"></td>
</tr>
 ...
 <td><input style="font-size:12px" size="50" style="background-color:#F5F5F5;" readonly="true" type="text" id="CROCS_UPE_ACCESS_PORT" name="CROCS_UPE_ACCESS_PORT" value="'.$CROCS_UPE_ACCESS_PORT.'"></td>
 <td></td>
<td style="background-color:#FFA500;"><font size="1">LAN IP:</font></td><td><input style="font-size:12px" size="50" style="background-color:#F5F5F5;" readonly="true" type="text" id="CROCS_BS_LAN_IP" name="CROCS_BS_LAN_IP" value="'.$CROCS_BS_LAN_IP.'">
</tr> 

 <tr>
 <td style="background-color:#FFA500;"><font size="1">UPE TRUNK PORT :</font></td>
 ...
 <td></td>
<td style="background-color:#FFA500;"><font size="1">UPE LOOPBACK IP:</font></td><td><input style="font-size:12px" size="50" style="background-color:#F5F5F5;" readonly="true" type="text" id="CROCS_BS_UPE_LOOPBACK_IP" name="CROCS_BS_UPE_LOOPBACK_IP" value="'.$CROCS_BS_UPE_LOOPBACK_IP.'"></tr> 
 '; }

echo '<tr><td style="background-color:#FFA500;"><font size="1">EPE NAME :</font></td><td><input style="font-size:12px" size="50" style="background-color:#F5F5F5;" readonly="true" type="text" id="CROCS_EPE_NAME" name="CROCS_EPE_NAME" value="'.$CROCS_EPE_NAME.'"></td><td></td>
<td style="background-color:#FFA500;"><font size="1">UPE HOSTNAME:</font></td><td><input style="font-size:12px" size="50" style="background-color:#F5F5F5;" readonly="true" type="text" id="CROCS_BS_UPE_HOSTNAME" name="CROCS_BS_UPE_HOSTNAME" value="'.$CROCS_BS_UPE_HOSTNAME.'"></td>
</tr>';

echo '<td style="background-color:#FFA500;"><font size="1">EPE PORT :</font></td><td><input style="font-size:12px" size="50" style="background-color:#F5F5F5;" readonly="true" type="text" id="CROCS_EPE_PORT" name="CROCS_EPE_PORT" value="'.$CROCS_EPE_PORT.'"></td></td><td></td><td style="background-color:#FFA500;"><font size="1">UPE ACCESS PORT:</font></td><td><input style="font-size:12px" size="50" style="background-color:#F5F5F5;" readonly="true" type="text" id="CROCS_BS_UPE_ACCESS_PORT" name="CROCS_BS_UPE_ACCESS_PORT" value="'.$CROCS_BS_UPE_ACCESS_PORT.'"></td>
</tr>';

echo '<tr><td></td><td></td><td></td></td><td style="background-color:#FFA500;"><font size="1">UPE TRUNK PORT:</font></td><td><input style="font-size:12px" size="50" style="background-color:#F5F5F5;" readonly="true" type="text" id="CROCS_BS_UPE_TRUNK_PORT" name="CROCS_BS_UPE_TRUNK_PORT" value="'.$CROCS_BS_UPE_TRUNK_PORT.'"></td></td>
</tr>';

echo '<tr><td></td><td></td><td></td></td><td style="background-color:#FFA500;"><font size="1">EPE NAME:</font></td><td><input style="font-size:12px" size="50" style="background-color:#F5F5F5;" readonly="true" type="text" id="CROCS_BS_EPE_NAME" name="CROCS_BS_EPE_NAME" value="'.$CROCS_BS_EPE_NAME.'"></td>
</tr>';

echo '<tr><td></td><td></td><td></td></td><td style="background-color:#FFA500;"><font size="1">EPE PORT:</font></td><td><input style="font-size:12px" size="50" style="background-color:#F5F5F5;" readonly="true" type="text" id="CROCS_BS_EPE_PORT" name="CROCS_BS_EPE_PORT" value="'.$CROCS_BS_EPE_PORT.'"></td>
</tr>';
...
?>
  ...
  <?php
        ...
        if ($Role <> 'GUEST'){
    			echo '				
    						<tr><td style="background-color:#FFA500;"><font size="1">CTT Number:</font></td><td><input style="font-size:12px" size="50" style="background-color:#F5F5F5;" readonly="true" type="text" 
                             ...
                             <td style="background-color:#FFA500;"><font size="1">CTT Priority:</font></td><td><input style="font-size:12px" size="50" style="background-color:#F5F5F5;" readonly="true" type="text" 
                              id="CROCS_CTT_PRIORITY" name="CROCS_CTT_PRIORITY" value="'.$CROCS_CTT_PRIORITY.'"></td></tr>';
 		  } else {
    			echo '<tr><td style="background-color:#FFA500;"><font size="1">CTT Number:</font></td><td><input style="font-size:12px" size="50" style="background-color:#F5F5F5;" readonly="true" type="text" 
                            id="CROCS_CTT_NO" name="CROCS_CTT_NO" value="'.$CROCS_CTT_NO.'"></td>
									 <td style="background-color:#FFA500;"><font size="1">CTT Priority:</font></td><td><input style="font-size:12px" size="50" style="background-color:#F5F5F5;" readonly="true" type="text" 
                            id="CROCS_CTT_PRIORITY" name="CROCS_CTT_PRIORITY" value="'.$CROCS_CTT_PRIORITY.'"></td></tr>';
       } 
  ...
  echo ' 
         <tr><td style="background-color:#FFA500;"><font size="1">CTT Service/Leg For Which Ticket is Raised:</font></td><td><input style="font-size:12px" size="50" style="background-color:#F5F5F5;" readonly="true"  
         type="text" id="CROCS_CTT_SVC_LEG" name="CROCS_CTT_SVC_LEG" value="'.$CROCS_CTT_SVC_LEG.'"></td>
         ...
         <tr><td style="background-color:#FFA500;"><font size="1">CTT Cause Category:</font></td><td><input style="font-size:12px" size="50" style="background-color:#F5F5F5;" readonly="true" 
   ...
   echo '
          <tr><td style="background-color:#FFA500;"><font size="1">CTT Resolution Code:</font></td><td><input style="font-size:12px" size="50" style="background-color:#F5F5F5;" readonly="true" type="text" 
          id="CROCS_CTT_RES_CODE" name="CROCS_CTT_RES_CODE" value="'.$CROCS_CTT_RES_CODE.'"></td></tr>'; 
   echo '
