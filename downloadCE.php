...
<div class="container1">
	<ul class="fa-ul">
        <li><i class="fa-li fa fa-spinner fa-pulse"  aria-hidden="true"></i>Listed below are the previously generated 
        database content files. You may download them by clicking on the file name.
        </li>
        <li><i class="fa-li fa fa-spinner fa-pulse"  aria-hidden="true"></i>If you wish to generate a new all database
        content report, please click the 'Generate New File' button.
        </li>
        <li><i class="fa-li fa fa-spinner fa-pulse"  aria-hidden="true"></i>If you wish to generate a new specific 
...
<tr bgcolor="#FFA500"><td>File Name</td><td>File Size (Kb)</td><td>Generated Date & Time</tr>
<?php
...
<ul class="fa-ul">
        <li><i class="fa-li fa fa-check-square" aria-hidden="true"></i>File generation may take more than 15 minutes.
        </li>
        <li><i class="fa-li fa fa-check-square" aria-hidden="true"></i>The file will be automatically downloaded once
        the generation is finished.
        </li>
        <li><i class="fa-li fa fa-check-square" aria-hidden="true"></i>Please do not refresh your browser until the 
        file is downloaded.
        </li>
	</ul>
