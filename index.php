...
<body>
<table border="0" align="center" background="images/loginbg.jpg" height="400"; width=1000><tr><td style="padding:20px 0px 5px 25px">&nbsp</td></tr>
<form method="POST" action="loginproc.php">
<tr align="center"><td align="center"><table border="0" bgcolor="#FFFFFF"><tr><td style="padding:25px 0px 0px 25px"><img src="images/title.jpg" width=290 /></td></tr>
<tr align="center"><td style="padding:15px 25px 5px 25px" colspan="2"><input type="text" name="username" size="25" 
<?php
 if ($username != '') 
    echo 'value="'.$username.'"';
 else
...
<tr align="center"><td style="padding:5px 25px 5px 25px" colspan="2"><input type="submit" value="Login"></td></tr>
...
<?php if ($loginmessage != '') echo '<tr><td style="padding:0px 25px 5px 25px" colspan =3><b><p style="color:red">'.$loginmessage.'</p></b></td></tr>'; ?></table>
<tr><td>&nbsp</td></tr><tr><td>&nbsp</td></tr></table>
