...
<div class="container1" style="margin:0 auto;margin-top:50; width:50%" align="center";>
    ...
    <i class="fas fa-cog fa-spin fa-5x" style="vertical-align: middle;color:#2b2a2a;" aria-hidden="true"></i>
    <blockquote>To capture the latest CE configuration prior to handover, retain resource order and CR activity. 
    </blockquote>
    </div>
    <div class="contentright" style="width:25%; float:right">
    <i class="fas fa-keyboard fa-5x" style="vertical-align: middle;color:#2b2a2a;" aria-hidden="true"></i>
    <blockquote>To input the latest preventive maintenance executed date for each managed CE. 
    </blockquote>
    </div>
</div>
